...
TriangleRenderer::TriangleRenderer(GameObject* go) { attachedObject = go; }
...
void TriangleRenderer::SetBaseLeft(const fVec2& v) { _coord.bl = v; }

void TriangleRenderer::SetBaseRight(const fVec2& v) { _coord.br = v; }

void TriangleRenderer::SetTop(const fVec2& v) { _coord.up = v; }

void TriangleRenderer::SetCoord(const TriangleCoord& v) { _coord = v; }
