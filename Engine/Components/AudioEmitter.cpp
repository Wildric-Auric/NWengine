...
void AudioEmitter::OnAdd() { Scene::GetCurrent()->AddToCache(AudioEmitter::ConditionHasAudioEmitter, *attachedObject); }

void AudioEmitter::OnDelete() { Scene::GetCurrent()->DeleteFromCache(AudioEmitter::ConditionHasAudioEmitter, *attachedObject); }

AudioEmitter::AudioEmitter() {}

AudioEmitter::AudioEmitter(GameObject* obj) { this->attachedObject = obj; }
...
void AudioEmitter::Play() { sound->Play(); }

void AudioEmitter::Stop() { sound->Stop(); }

void AudioEmitter::Pause() { sound->Pause(); }

void AudioEmitter::Resume() { sound->Resume(); }
