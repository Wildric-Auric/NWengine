...
Transform::Transform(GameObject* go) { this->attachedObject = go; }
...
fVec2 Transform::GetRotationAnchor() { return rotationAnchor; }

void Transform::SetRotationAnchor(const fVec2& ar) { rotationAnchor = ar; }
