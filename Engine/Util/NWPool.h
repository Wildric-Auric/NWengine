...
class NWPool {
  public:
	...
	void SetRecycle(bool r = 1) { _recycleFlag = r; }

	bool GetRecycle() { return _recycleFlag; }
	...
	void MapAll(NW_Pool_Func_Type(f), void* d) { MapTo(f, d, _container.size()); }

	void Map(NW_Pool_Func_Type(f), void* d) { MapTo(f, d, _active.size()); }
