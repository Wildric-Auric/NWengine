...
void NWTime::Init() { _timer.initialize(); }
...
const double& NWTime::GetFPS() { return _FPS; }

const double& NWTime::GetDeltaTime() { return _deltaTime; }
...
bool NWTimer::Update() { return Update(NWTime::GetDeltaTime()); }

bool NWTimer::HasFinished() { return GetVal() >= _maxx; }
