...
int Batch::DefaultBatchDrawCallback(void* data) {
	...
	/*      x         y          z     uv.x uv.y          user.x                    user.y                       user.z ext  tex
			vert0.x, vert0.y, vert0.z, 0.0, 0.0, sprite->vertexAttributes.x, sprite->vertexAttributes.y,
	   sprite->vertexAttributes.z, ... -1.0, vert1.x, vert1.y, vert0.z, 1.0, 0.0, sprite->vertexAttributes.x,
	   sprite->vertexAttributes.y, sprite->vertexAttributes.z, ... -1.0, vert3.x, vert3.y, vert0.z, 0.0, 1.0,
	   sprite->vertexAttributes.x, sprite->vertexAttributes.y, sprite->vertexAttributes.z, ... -1.0, vert2.x, vert2.y,
	   vert0.z, 1.0, 1.0, sprite->vertexAttributes.x, sprite->vertexAttributes.y, sprite->vertexAttributes.z, ... -1.0
	*/
#define SET(i, e) stride[i + offset] = e;
	...
	SET(2, vert0.z)
	SET(3, 0.0)
	SET(4, 0.0) SET(5, sprite->vertexAttributes.x) SET(6, sprite->vertexAttributes.y) SET(7, sprite->vertexAttributes.z)
		SET(8 + c, -1.0)
	...
	SET(2, vert0.z)
	SET(3, 0.0)
	SET(4, 1.0) SET(5, sprite->vertexAttributes.x) SET(6, sprite->vertexAttributes.y) SET(7, sprite->vertexAttributes.z)
		SET(8 + c, -1.0)
