...
QuadInternal::QuadInternal() {
	float vertices[] = {
		// VertexPos                //uv
		-0.5, -0.5, 0.0f, 0.0f, 0.0f, 0.5, -0.5, 0.0f, 1.0f, 0.0f, -0.5, 0.5, 0.0f, 0.0f, 1.0f, 0.5, 0.5, 0.0f, 1.0f, 1.0f,
	};
...
TriangleInternal::TriangleInternal() {
	float vertices[] = {
		// VertexPos                //uv
		-0.5, -0.5, 0.0f, 0.0f, 0.0f, 0.5, -0.5, 0.0f, 1.0f, 0.0f, 0.25, 0.5, 0.0f, 1.0f, 1.0f,
	};
	uint32 indices[] = {
		0,
		2,
...
Triangle::Triangle(float w, float h) { UpdateSize(w, h); }

void Triangle::Draw() { TriangleInternal::triInstance.Draw(); }
...
void QuadInternal::Delete() { DelGLObjs(_gldat); }
...
void Quad::Draw() { QuadInternal::quadInstance.Draw(); }
...
void Primitives::Destroy() { QuadInternal::quadInstance.Delete(); }
