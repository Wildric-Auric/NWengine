...
/*Each vertex has 24 byte of data :
* -------------------
...
const uint32 Batch::strideSizeByte   = 24;
const uint32 Batch::strideSize       = 6;
...
Batch::Batch() {
	...
	glVertexAttribPointer(2, 1, GL_FLOAT, GL_FALSE, Batch::strideSizeByte, (const void*)20);
